...
const plans = [
  {
    ...
    paymentLink:
      process.env.NODE_ENV === "development"
        ? "https://buy.stripe.com/test_4gw3cI0bH8aG1dGdQk"
        : "https://buy.stripe.com/4gw3cI0bH8aG1dGdQk",
    priceId:
      process.env.NODE_ENV === "development"
        ? "price_1N4Zy2Lqz5b1dGdQk"
        : "price_1N4Zy2Lqz5b1dGdQk",
  },
  {
    id: "pro",
  ...
  return (
    <div className="relative w-full max-w-lg hover:scale-105 hover:transition-all duration-300">
      ...
      >
        ...
        <div className="spacce-y-2 flex justify-center w-full">
          <Link
            href={paymentLink}
            className={cn(
